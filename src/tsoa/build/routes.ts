...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { TsoaController } from './../tsoa.controller';
...
const models: TsoaRoute.Models = {
    "ExampleError": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"code":{"dataType":"double","required":true},"message":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "ExampleThing": {
        "dataType": "refObject",
    ...
    "FetchThingsResponse": {
        "dataType": "refObject",
        "properties": {
            "request": {"dataType":"union","subSchemas":[{"dataType":"any"},{"dataType":"string"}],"required":true},
            "error": {"ref":"ExampleError"},
            "result": {"dataType":"array","array":{"dataType":"refObject","ref":"ExampleThing"},"required":true},
        },
        "additionalProperties": true,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "FetchThingResponse": {
        ...
        "properties": {
            "request": {"dataType":"union","subSchemas":[{"dataType":"any"},{"dataType":"string"}],"required":true},
            "error": {"ref":"ExampleError"},
            "result": {"ref":"ExampleThing","required":true},
        },
        "additionalProperties": true,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/things',
            ...
            function TsoaController_fetchThings(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const method: ExampleMethod = TsoaController.fetchThings;
                const promise = method(...validatedArgs as any);

                const controller = { getStatus: async () => { return (await promise)?.error?.code; }, getHeaders: () => { }};
        ...
        app.get('/api/things/:id',
            ...
            function TsoaController_fetchThing(request: any, response: any, next: any) {
            const args = {
            ...
            try {
                ...
                const method: ExampleMethod = TsoaController.fetchThing;
                const promise = method(...validatedArgs as any);
